...
- Because this tool was intended for comparison against the SMC test, the default range in the code is set to ±30%. This value can be adjusted by changing just a single line in the code
